...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update query
    $sql = "UPDATE Veterinary SET Name = '$name', ContactNumber = '$contactNumber' WHERE VeterinaryID = $veterinaryID";
...
<head>
    ...
    <title>Update Veterinary Record</title>
    <style>
        body {
...
<body>
    <a href="vet.php" class="redirect-button">Veterinary</a>

    <h2>Update Veterinary Record</h2>
